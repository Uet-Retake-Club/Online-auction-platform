...
public class AdminController implements Initializable {
    ...
    @FXML private VBox  usersTableContainer;
    @FXML private VBox  auctionsTableContainer;
    @FXML private VBox  dashboardTab;
    @FXML private VBox  tabPlaceholder;
    @FXML private Button navDashboard;
    @FXML private Button navUsers;
    @FXML private Button navAuctions;
    @FXML private Button navBids;
    ...
    private String smallBtnStyle(boolean danger) {
        if (danger) return "-fx-background-color:#FDECEA;-fx-text-fill:#E53238;" +
